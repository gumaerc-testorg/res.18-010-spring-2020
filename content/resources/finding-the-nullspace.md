...
video_metadata:
  video_tags: nullspace, solution vectors, special solutions, elimination, Ax = 0
  youtube_description: "A Vision of Linear Algebra\nInstructor: Gilbert Strang\nView\
    ...
    \nThis new video computes the nullspace of any matrix A. The equation Ax = 0 is\
    \ reduced to row echelon form Rx = 0. Then all solution vectors are combinations\
    \ of \"special solutions.\u201D  We understand the pieces of R from the factorization\
    \ A = CR. \n\nSee also Lecture 7 from 18.06 Linear Algebra for more on this topic\
    \ at https://ocw.mit.edu/1806videoslec7/\n\nLicense: Creative Commons BY-NC-SA\n\
